...
// Components
import { FaLink } from "react-icons/fa"; // استبدل FaPlay بـ FaLinkimport ModalIframeButton from '@/app/components/builds/ModalIframeButton';
import ModalIframeButton from '@/app/components/builds/ModalIframeButton';
...
import Room from '@/app/scenes/room3/Room';
  ...
  return (
    <main style={{ width: '100vw', height: '100vh' }}>
      ...
      <Physics gravity={[0, -9.81, 0]} >
        <Room modelPath="/models/buildings/room3.glb" position={[0, 0, 0]} />

            <NPCModel ref={(el: RapierRigidBody | null) => { npcRefs.current['prof4'] = el;}} url="/models/prof4.glb"
              position={[-10, .5, -9]} scale={2.5}  name="prof4" playerRef={playerRef} 
              tdistance={7} onDialogueOpen={(npcName) => setActiveNpc(npcName)} setShowDialogue={setShowDialogue}  />

            <Player  position={[-20, 3, 5]}  scale = {[1, 1, 1]} cameraH = {5} rotationSpeed={3} // دوران أسرع
      ...
      {showImage && (
        ...
        >
          <div style={{ position: 'relative', width: '300px' }}>
            ...
            />
                      <ModalIframeButton
            iframeUrl=" https://academy.msaaq.com/courses/%D8%A7%D9%84%D8%AA%D8%B5%D9%85%D9%8A%D9%85-%D8%A7%D9%84%D8%AA%D8%B9%D9%84%D9%8A%D9%85%D9%8A-instructional-design-101"
            buttonText="شاهد"
            icon={FaLink}
          />
          </div>
