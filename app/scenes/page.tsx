...
import { VRCanvas, XR, Hands } from '@react-three/xr';
import PlayerVRControls from '@/app/components/player/PlayerVRControls';
...
export default function HomePage() {
  ...
  const [, setPlayerPos] = useState(new THREE.Vector3(0, 0, 0));
  ...
  return (
    <main style={{ width: '100vw', height: '100vh' }}>
      ...
      {/* WebXR Canvas */}
<VRCanvas shadows camera={{ position: [0, 5, 10], fov: 60 }} gl={{ antialias: true }}>
        <XR>
          <Hands />
          <PlayerVRControls />
          <Skybox />
          ...
          <Physics gravity={[0, -9.81, 0]}>
            ...
            <SimpleDoor
              ...
              position={[14.5, 0, 7.5]}
              scale={[1, 1, 1]}
              redirectUrl="/scenes/room1"
            />
            <Signboard text="Amira's lab" position={[14.5, 8, 7]} scale={[6, 2, 0.1]} />

            <SimpleDoor
              playerRef={playerRef}
              url="/models/door.glb"
              rotation={[0, Math.PI / 2, 0]}
              position={[-35.6, 0, 43.4]}
              scale={[1, 1, 1]}
              redirectUrl="/scenes/room2"
            />
            <Signboard
              text="lab1"
              rotation={[0, Math.PI / 2, 0]}
              position={[-28.25, 7.4, 42]}
              scale={[6, 2.2, 0.1]}
            />
            ...
            <SimpleDoor
              playerRef={playerRef}
              url="/models/door.glb"
              position={[28.2, 0.01, 54.5]}
              scale={[1, 1, 1]}
              redirectUrl="/scenes/room3"
            />
            ...
            <SimpleDoor
              ...
              position={[-21, 0, -80]}
              scale={[1, 1, 1]}
              redirectUrl="/scenes/room4"
            />
            <Signboard
              text="lab4"
              rotation={[0, Math.PI / 2, 0]}
              position={[-21.25, 6.8, -80]}
              scale={[6, 2.2, 0.1]}
            />
            ...
            <SimpleDoor
              playerRef={playerRef}
              url="/models/door.glb"
              position={[26.5, 0.09, -63.5]}
              scale={[1, 1, 1]}
              redirectUrl="/scenes/room5"
            />
            <Signboard
              text="lab5"
              rotation={[0, Math.PI, 0]}
              position={[26.5, 6.7, -63.5]}
              scale={[6, 2, 0.1]}
            />

            {/* NPCs */}
            <NPCModel
              ref={(el: RapierRigidBody | null) => { npcRefs.current['npc1'] = el; }}
              url="/models/npc1.glb"
              position={[50, 0, -50]}
              scale={1}
              name="npc1"
            ...
            />
            <NPCModel
              ref={(el: RapierRigidBody | null) => { npcRefs.current['wpc3'] = el; }}
              url="/models/wpc3.glb"
              position={[-8, 0, 11]}
              scale={1}
              name="wpc3"
            ...
            />
            <NPCModel
              ref={(el: RapierRigidBody | null) => { npcRefs.current['wpc2'] = el; }}
              url="/models/wpc2.glb"
              position={[30, 0, 11]}
              scale={1}
              name="wpc2"
